...
const Tires = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setForm({ vehicleId: '', date: '', type: 'Alignment', cost: '', odometer: '', notes: '' });
  };
  ...
  return (
    <div className="p-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
        <div>
          <h1 className="text-2xl font-bold">Tire & Alignment</h1>
          <p className="text-sm text-gray-600 mt-1">Record alignments, balancing and tire replacement services.</p>
        </div>
      ...
      <div className="bg-white p-6 rounded-xl shadow-sm mb-8">
        <h2 className="text-lg font-semibold mb-4">Add Tire Record</h2>
      ...
      <div className="bg-white p-6 rounded-xl shadow-sm">
        <h2 className="text-lg font-semibold mb-4">Tire Record History</h2>
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              ...
              {entries.length === 0 && (
                <tr>
                  <td colSpan="5" className="px-4 py-6 text-center text-sm text-gray-500">No tire records yet.</td>
                </tr>
              )}
            </tbody>
          </table>
